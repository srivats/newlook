...
function roots_sidebar() {
  if (is_404() || is_page_template('page-custom.php') || is_page_template('page-home.php') || is_page_template('page-contact.php') || is_page_template('page-fullwidth.php') || is_home()) {
    return false;
  } else {
    return true;
  }
